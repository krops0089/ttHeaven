...
public class KeyBindings {
    ...
    public static void register() {
        ...
        net.minecraftforge.client.registry.ClientRegistry.registerKeyBinding(menuKey);
        net.minecraftforge.client.registry.ClientRegistry.registerKeyBinding(scanKey);
    }
